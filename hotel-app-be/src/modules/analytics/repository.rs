...
pub async fn generate_report(
    ...
    let report_data = match params.report_type.as_str() {
        ...
        "channel_net_revenue" | "ota_commission" => {
            super::channel_net_revenue::generate(pool, &params, start_date, end_date).await?
        }
...
async fn generate_general_journal(
    ...
    let rows = sqlx::query(
        ...
        SELECT
            ...
            -- PostgreSQL 19 baseline VIRTUAL generated column (migration 019): tourism_tax_amount
