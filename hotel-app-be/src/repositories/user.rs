...
impl UserRepository {
    ...
    pub async fn find_by_username_or_email(pool: &PgPool, identifier: &str) -> Result<Option<User>, ApiError> {
        sqlx::query_as::<_, User>(
            r#"
            SELECT id, username, email, full_name, phone, is_active, is_verified, user_type,
                   two_factor_enabled, two_factor_secret, two_factor_recovery_codes,
    ...
    /// Get user profile
    pub async fn get_profile(pool: &PgPool, user_id: i64) -> Result<Option<UserProfile>, ApiError> {
    ...
    pub async fn get_password_hash(pool: &PgPool, user_id: i64) -> Result<String, ApiError> {
    ...
    pub async fn is_super_admin(pool: &PgPool, user_id: i64) -> Result<bool, ApiError> {
    ...
    /// Get user roles
    pub async fn get_roles(pool: &PgPool, user_id: i64) -> Result<Vec<String>, ApiError> {
    ...
    pub async fn get_permissions(pool: &PgPool, user_id: i64) -> Result<Vec<String>, ApiError> {
    ...
    pub async fn has_permission(pool: &PgPool, user_id: i64, permission: &str) -> Result<bool, ApiError> {
