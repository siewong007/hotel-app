...
pub fn row_to_booking_with_details(row: &DbRow) -> BookingWithDetails {
    ...
    BookingWithDetails {
        ...
        total_paid: get_opt_decimal(row, "total_paid"),
        total_refunded: get_opt_decimal(row, "total_refunded"),
        balance_due: get_opt_decimal(row, "balance_due"),
        deposit_refunded: get_opt_bool(row, "deposit_refunded"),
        ...
        is_tourist: get_opt_bool(row, "is_tourist"),
        tourism_tax_amount: get_opt_decimal(row, "tourism_tax_amount"),
        extra_bed_count: row.try_get("extra_bed_count").ok(),
        extra_bed_charge: get_opt_decimal(row, "extra_bed_charge"),
...
pub fn row_to_booking(row: &DbRow) -> Booking {
    Booking {
        ...
        commission_amount: get_opt_decimal(row, "commission_amount"),
        net_revenue: get_opt_decimal(row, "net_revenue"),
