...
required_payload=(
  ...
  database/patches/0019_guest_relations.sql
)
...
install_release_files() {
  ...
  install -m 0644 "$RELEASE_DIR/database/patches/0019_guest_relations.sql" "$APP_DIR/database/patches/0019_guest_relations.sql"
