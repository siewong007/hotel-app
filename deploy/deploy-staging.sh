...
required_payload=(
  ...
  database/patches/0024_deposit_forfeited.sql
)
...
install_release_files() {
  ...
  install -m 0644 "$RELEASE_DIR/database/patches/0024_deposit_forfeited.sql" "$APP_DIR/database/patches/0024_deposit_forfeited.sql"
