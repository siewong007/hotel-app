...
/**
 * Legacy single-date hook kept alive only for `OnlineInventoryPage` until the
 * grid page replaces it. Deleted with the card UI.
 */
...
export const useLegacyOnlineInventory = (stayDate: string) => {
