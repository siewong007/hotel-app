...
import { getCategoryColor, getCategoryDisplayName } from '../constants';
          ...
          return (
            ...
            >
              ...
              >
                ...
                <IconButton size="small" sx={{ p: 0 }} aria-label={isExpanded ? t('rbac.collapseSection') : t('rbac.expandSection')}>
                  {isExpanded ? (
