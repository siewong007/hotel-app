...
import HotelInfoCard from "./settings/HotelInfoCard";
import ChargesCard from "./settings/ChargesCard";
import SupportWorkflowCard, {
  type SupportPriority,
} from "./settings/SupportWorkflowCard";
    ...
    <Box>
      ...
      {activeTab === "hotel" && (
        <>
          ...
          <HotelInfoCard
            ...
            onHotelPhoneChange={setHotelPhone}
            hotelEmail={hotelEmail}
            onHotelEmailChange={setHotelEmail}
            hotelBusinessNumber={hotelBusinessNumber}
            ...
            onNightShiftTimeChange={setNightShiftTime}
            nightAuditAutoEnabled={nightAuditAutoEnabled}
            onNightAuditAutoEnabledChange={setNightAuditAutoEnabled}
            currency={currency}
      ...
      {activeTab === "finance" && (
        <>
          ...
          <ChargesCard
            ...
            onServiceTaxRateChange={setServiceTaxRate}
            tourismTaxRate={tourismTaxRate}
            onTourismTaxRateChange={setTourismTaxRate}
            depositAmount={depositAmount}
            onDepositAmountChange={setDepositAmount}
            unpaidHoldReleaseHours={unpaidHoldReleaseHours}
            onUnpaidHoldReleaseHoursChange={setUnpaidHoldReleaseHours}
            defaultPaymentTermsDays={defaultPaymentTermsDays}
            onDefaultPaymentTermsDaysChange={setDefaultPaymentTermsDays}
          />
        </>
      )}
      {activeTab === "reports" && (
      ...
      {activeTab === "guest" && (
        <>
          ...
          <SupportWorkflowCard
            isAdmin={isAdmin}
            guestBookingCancellationEnabled={guestBookingCancellationEnabled}
            onGuestBookingCancellationEnabledChange={
              setGuestBookingCancellationEnabled
            }
            supportEnabled={supportEnabled}
            onSupportEnabledChange={setSupportEnabled}
            supportCategories={supportCategories}
            onSupportCategoriesChange={setSupportCategories}
            supportFirstResponseMinutes={supportFirstResponseMinutes}
            onSupportFirstResponseMinutesChange={setSupportFirstResponseMinutes}
            supportResolutionMinutes={supportResolutionMinutes}
            onSupportResolutionMinutesChange={setSupportResolutionMinutes}
            supportReopenWindowDays={supportReopenWindowDays}
            onSupportReopenWindowDaysChange={setSupportReopenWindowDays}
          />
        </>
      )}
      {activeTab === "security" && (
        <>
          ...
          <SecurityCard
            ...
            onMaxLoginAttemptsChange={setMaxLoginAttempts}
            totpIssuerName={totpIssuerName}
            onTotpIssuerNameChange={setTotpIssuerName}
            passkeyRelyingPartyName={passkeyRelyingPartyName}
            onPasskeyRelyingPartyNameChange={setPasskeyRelyingPartyName}
            hotelName={hotelName}
          />
        </>
      )}
