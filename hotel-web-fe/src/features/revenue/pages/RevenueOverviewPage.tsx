...
import { addLocalDays, formatLocalDate, formatHotelDate } from '../../../utils/date';
  ...
  return (
    <Box>
      <PageHeader
        ...
        subtitle={
          data
            ? t('overview.rangeSubtitle', {
                from: formatHotelDate(data.range.from),
                to: formatHotelDate(data.range.to),
                prevFrom: formatHotelDate(data.previous_period.from),
                prevTo: formatHotelDate(data.previous_period.to),
              })
            : t('overview.subtitle')
        }
      />
