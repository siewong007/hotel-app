                  ...
                  <TableRow key={role.id} hover>
                    ...
                    <TableCell>
                      <Tooltip title="View Permissions">
                        <IconButton size="small" onClick={() => handleViewRole(String(role.id))} color="primary">
                          <EditIcon />
                        </IconButton>
                      </Tooltip>
                    </TableCell>
          ...
          <Box sx={{ display: 'flex', flexWrap: 'wrap', gap: 1, mt: 2 }}>
            {selectedRole?.permissions.map((perm) => (
              <Chip
                ...
                variant="outlined"
                onDelete={() => {
                  handleRemovePermission(String(selectedRole.role.id), String(perm.id));
          ...
          <Box sx={{ display: 'flex', flexWrap: 'wrap', gap: 1, mt: 1, mb: 2 }}>
            {selectedUser?.roles.map((role) => (
              <Chip
                ...
                color="primary"
                onDelete={() => {
                  handleRemoveRole(selectedUser.user.id, String(role.id));
