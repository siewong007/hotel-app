...
DECLARE
    ...
    current_definition constant text :=
        'CHECK (((status)::text = ANY (ARRAY[(''pending''::character varying)::text, (''pending_payment''::character varying)::text, (''pending_confirmation''::character varying)::text, (''confirmed''::character varying)::text, (''checked_in''::character varying)::text, (''auto_checked_in''::character varying)::text, (''checked_out''::character varying)::text, (''no_show''::character varying)::text, (''completed''::character varying)::text, (''comp_void''::character varying)::text, (''partial_complimentary''::character varying)::text, (''fully_complimentary''::character varying)::text, (''voided''::character varying)::text])))';
    old_definition constant text :=
        'CHECK (((status)::text = ANY (ARRAY[(''pending''::character varying)::text, (''confirmed''::character varying)::text, (''checked_in''::character varying)::text, (''auto_checked_in''::character varying)::text, (''checked_out''::character varying)::text, (''no_show''::character varying)::text, (''completed''::character varying)::text, (''comp_void''::character varying)::text, (''partial_complimentary''::character varying)::text, (''fully_complimentary''::character varying)::text, (''voided''::character varying)::text])))';
BEGIN
