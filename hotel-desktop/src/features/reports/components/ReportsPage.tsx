...
const ReportsPage: React.FC = () => {
  ...
  const exportToCSV = async () => {
    ...
    // Use Tauri-compatible file save
    const filename = `hotel_report_${filterType}_${new Date().toISOString().split('T')[0]}.csv`;
    await saveFile({ filename, content: csv, mimeType: 'text/csv' });
  };
